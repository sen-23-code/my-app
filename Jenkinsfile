node{
   ...
   stage('Nexus Image Push'){
     ...
     {
     sh "docker login -u admin -p ${nexusPassword} 3.110.81.123:8083"
     sh "docker tag balajihooghli/myweb:0.0.2 3.110.81.123:8083/balhoogh:1.0.0"
     sh 'docker push 3.110.81.123:8083/balhoogh:1.0.0'
   }
   }
